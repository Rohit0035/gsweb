        ...
        <div className="row">
          <Jumbotron className="shadow p-4 mb-5 bg-white rounded mt-50">
            <div className="col-sm-12">
              ...
              <p>
              NEXUS PAY is not only an emerging crypto currency platform that is built on TRC 20 (Tron Smart chain) and BEP-20 (Binance Chain) but also has features of transparency and Initial coin distribution which we believe is crucial for the long-term feasibility and decentralization. NEXUS PAY is complete all in one ecosystem that contains the Staking, Launchpad, NFT marketplace, and swapping facility under an umbrella.NEXUS PAY is also using in utility services for over 4r5 countries in phase wise offering through NEXUS PAY. NEXUS PAY also bringing exchange services. NEXUS PAY used block chain technology to make its NFT marketplace Unique. Community members are also involved in decision making to make feel true ownership of their asset. To connect the different block chain platform under an umbrella NEXUS PAY started a platform SOXYBRIDGE & By using NEXUS PAY SWAP digital asset can be converted into desired form.
...
We strive to create an ecosystem based on sound monetary policies, with a sound and solid decentralized foundation, that should be expected with the Lift coin digital asset
            ...
            <div className="col-sm-12">
              ...
              <h2>Our Mission</h2>
              <p>
              NEXUS PAY  utility will become a powerful weapon for normal household people globally for utilizing day to day needs .
              </p>
               </div>
            </div>
          </div>
